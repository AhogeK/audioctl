...
// 前向声明
static OSStatus
aggregate_volume_set_physical_device_volume (Float32 volume);
static OSStatus
aggregate_volume_set_physical_device_mute (bool isMuted);
...
aggregate_volume_get_physical_device_volume (Float32 *outVolume)
{
  ...
  OSStatus status
    = AudioObjectGetPropertyData (physicalDevice, &g_volume_address, 0, NULL,
				  &dataSize, outVolume);
...
aggregate_volume_set_physical_device_volume (Float32 volume)
{
  ...
  // 设置物理设备的音量
  OSStatus status
    = AudioObjectSetPropertyData (physicalDevice, &g_volume_address, 0, NULL,
...
aggregate_volume_set_physical_device_mute (bool isMuted)
{
  ...
  // 设置物理设备的静音状态
  OSStatus status
    = AudioObjectSetPropertyData (physicalDevice, &g_mute_address, 0, NULL,

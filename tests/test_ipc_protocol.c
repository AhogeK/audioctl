...
static int test_ipc_header_init(void)
{
    ...
    {
        printf("    ❌ FAIL: Magic number mismatch (expected 0x%08X, got 0x%08X)\n",
...
static int test_ipc_header_validation(void)
{
...
static int test_ipc_socket_path(void)
{
...
static int test_ipc_status_strings(void)
{
...
static int test_ipc_struct_sizes(void)
{
...
int run_ipc_protocol_tests(void)
{
    printf("\n----------------------------------------\n");

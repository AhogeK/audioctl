...
extern int
run_basic_device_tests (void);
extern int
run_device_control_tests (void);
extern int
run_audio_control_tests (void);
extern int
run_audio_processing_tests (void);
extern int
run_device_state_tests (void);

// 新增测试
extern int
run_app_volume_control_tests (void);
extern int
